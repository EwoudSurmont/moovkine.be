...
export const SITE_CONFIG = {
  ...
  defaultDescription: "MOOV Kine is een multidisciplinaire groepspraktijk voor kinesitherapie gelegen te Kortemark. Gespecialiseerd in manuele therapie, sportrevalidatie, zwangerschapsbegeleiding en meer.",
